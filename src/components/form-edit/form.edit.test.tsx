...
describe('Given FormEdit component', () => {
  describe('When we instantiate', () => {
    ...
    test.skip('Then it should be in the document', () => {
      const element = screen.getByRole('form');
      expect(element).toBeInTheDocument();
    });

    test.skip('Then it should display the offer image', () => {
      const imageElement = screen.getByAltText('offer image');
      expect(imageElement).toBeInTheDocument();
    });

    test.skip('Then it should display the offer title', () => {
    ...
    test.skip('Then it should display the offer description', () => {
    ...
    test.skip('Then it should display the regular price', () => {
    ...
    test.skip('Then it should display the offer price', () => {
    ...
    test.skip('Then it should display the coupon', () => {
    ...
    test.skip('Then it should display the offer URL', () => {
    ...
    test.skip('Then it should display the category', () => {
    ...
    test.skip('Then it should display the edit offer button', () => {
